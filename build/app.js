...
function changer() {
  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { title: list };
...
var Cart = function (_React$Component) {
  ...
  function Cart(props) {
    ...
    _this.state = {
      hotlist: [_react2.default.createElement('li', null)]
    };
    return _this;
  }
  ...
  _createClass(Cart, [{
    ...
    value: function componentDidMount() {
      ...
      var url = 'http://localhost:3000/cart.php';
      fetch(url).then(function (response) {
        return response.json();
      }).then(function (res) {
        // console.log(res.content[0].result)
        var arr = res.content[0].result;
        console.log(arr);
        var list = arr.map(function (val) {
          ...
          return _react2.default.createElement(
            ...
            _react2.default.createElement(
              'a',
              null,
              _react2.default.createElement('span', { className: 'gou' })
            )
          );
        });
        _this2.setState({
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    value: function componentWillMount() {
      var url = "http://localhost:3000/home.php";
      var that = this;
      fetch(url).then(function (response) {
        return response.json();
      }).then(function (data) {
        ...
        for (var i = 0; i < 3; i++) {
          arr.push(_react2.default.createElement(
            'li',
            { className: 'item' },
            _react2.default.createElement('img', { className: 'img', src: data.content[0].items[1].data[i].image })
          ));
        }
        console.log(data.content[0].items[2].data[0].image.image);
        kaquan.push(_react2.default.createElement('img', { src: data.content[0].items[2].data[0].image.image }));
        var newNav = data.content[0].items[3].data.map(function (val) {
          return _react2.default.createElement(
            'li',
            null,
            _react2.default.createElement(
        ...
        attr.push(_react2.default.createElement(
          'h2',
          null,
          _react2.default.createElement('img', { className: 'pic', src: data.content[0].items[4].attributes.iconUrl }),
          _react2.default.createElement(
            'b',
            null,
            data.content[0].items[4].attributes.title
          )
        ));

        var newShop = data.content[0].items[4].data.map(function (val) {
          return _react2.default.createElement(
            'li',
            { 'data-id': val.itemId },
            _react2.default.createElement(
            ...
            _react2.default.createElement('a', { className: 'btnshop' })
          );
        });
        var kindfood1 = [];
        kindfood1.push(_react2.default.createElement(
          'div',
          { className: 'food' },
          _react2.default.createElement(
            'h2',
            null,
            _react2.default.createElement('img', { src: data.content[0].items[5].attributes.iconUrl }),
            _react2.default.createElement(
              'b',
              null,
              data.content[0].items[5].attributes.title
            )
          ),
          _react2.default.createElement(
            'a',
            { className: 'foodpic' },
            _react2.default.createElement('img', { src: data.content[0].items[5].attributes.image }),
            _react2.default.createElement(
              'span',
              null,
              _react2.default.createElement('img', { src: 'http://s1.ucaiyuan.com/h5/1.6.4/images/my/sanjiao.png' })
            )
          )
        ));
        var pina = [];
        data.content[0].items[5].data.map(function (val) {
          pina.push(_react2.default.createElement(
            'ul',
            null,
            _react2.default.createElement(
              'li',
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'biaoyu' },
          _react2.default.createElement('img', { src: 'http://s1.ucaiyuan.com/h5/1.6.4/images/my/slogan.png' })
        )
      );
    }
  }]);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement(
              'li',
              { className: 'captcha' },
              _react2.default.createElement('input', { id: 'yanzheng', placeholder: '\u8BF7\u8F93\u5165\u9A8C\u8BC1\u7801' }),
              _react2.default.createElement(
                'div',
                { id: 'yan' },
                '\u53D1\u9001\u9A8C\u8BC1\u7801'
            ...
            _react2.default.createElement(
              'li',
              { className: 'password' },
              _react2.default.createElement('input', { type: 'password', placeholder: '\u8BF7\u8F93\u5165\u5BC6\u7801(\u4E0D\u5C11\u4E8E6\u4F4D)' })
            )
          ),
          _react2.default.createElement(
            'div',
...
var _reactAddonsShallowCompare = __webpack_require__(40);
...
var __WEBPACK_AMD_DEFINE_RESULT__;/* REACT HOT LOADER */ if (false) { (function () { var ReactHotAPI = require("E:\\project\\gmds\\node_modules\\.0.4.7@react-hot-api\\modules\\index.js"), RootInstanceProvider = require("E:\\project\\gmds\\node_modules\\.1.3.1@react-hot-loader\\RootInstanceProvider.js"), ReactMount = require("react-dom/lib/ReactMount"), React = require("react"); module.makeHot = module.hot.data ? module.hot.data.makeHot : ReactHotAPI(function () { return RootInstanceProvider.getRootInstances(ReactMount); }, React); })(); } try { (function () {
...
var _reactTapEventPlugin = __webpack_require__(53);
...
var _kind = __webpack_require__(24);
...
__webpack_require__(27); //只写require不需要返回，一旦引进来就把模块打包起来
...
var defaultClickRejectionStrategy = __webpack_require__(52);
...
should be injected by the application.'
  ...
  __webpack_require__(13).injection.injectEventPluginsByName({
    'TapEventPlugin':       __webpack_require__(50)(shouldRejectClick)
  });
};
